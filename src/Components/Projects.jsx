...
const Projects = () => {
  const Myntralink = () => {
    window.open("https://splendorous-cocada-8e1e1f.netlify.app/index.html");
  };
  const Myntragithublink = () => {
    window.open("https://github.com/Saurav9284/Myntra-Project");
  };
  ...
  const GemGardenlink = () => {
    window.open("https://frolicking-pudding-69eee6.netlify.app/");
  };
  ...
  const Notepadlink = () => {
    window.open("https://majestic-naiad-5e4a13.netlify.app/login");
  };
  const Notepadgithublink = () => {
    window.open("https://github.com/Saurav9284/Notepad-FullStack");
  };
  ...
  return (
    <div className="Projects-maindiv" id="projects">
      ...
      <div className="Projectcards-div">
        ...
        <div className="card project-card">
          ...
          <div className="content">
            ...
            <p className="para project-description">
              ...
              sell personalized gift items. In May 2014, Myntra.com was acquired
              by Flipkart."
            </p>
        ...
        <div className="card project-card">
          <div>
            <img className="projectimage" src={Notepad} alt="eduhub" />
            <div className="btnhover">
              <button
                className="Btn project-deployed-link"
                onClick={Notepadlink}
          ...
          <div className="content">
            <p className="heading project-title">Notepad Fullstack</p>

            <p className="para project-description">
              "A comprehensive individual full-stack project was successfully
              completed in seven days. This project enables users to create
              accounts, log in, and, upon successful login, allows them to
              create, edit, and delete their notes. Additionally, users have
              access to sorting, filtering, and searching functions to enhance
        ...
        <div className="card project-card">
          ...
          <div className="content">
            ...
            <p className="para project-description">
              "Glossier is a popular cosmetics and skincare company known for
              its minimalist and clean product designs. They sell a variety of
              makeup, skincare, and beauty products, and they have an online
              store where you can browse and purchase their products."
            </p>
            <div className="project-tech-stack techstacks">
              <Tooltip
                label="HTML"
        ...
        <div className="card project-card">
          ...
          <div className="content">
            <p className="heading project-title">Gem Garden</p>
            <p className="para project-description">
              "At Gem Garden, an online jewelry store, you can effortlessly
              browse and purchase your preferred jewelry items from the comfort
              of your own home."
            </p>
            <div className="project-tech-stack techstacks">
              <Tooltip
